...
public class HonorsAdapter extends RecyclerView.Adapter<HonorsAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            textView = itemView.findViewById(R.id.honorRecyclerTextView);
            button = itemView.findViewById(R.id.deleteButtonHonor);
        }
    }

    public HonorsAdapter(ArrayList<String> newList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.honors_recycler, parent, false);
